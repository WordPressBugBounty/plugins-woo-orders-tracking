...
class VI_WOO_ORDERS_TRACKING_FRONTEND_TRACKING_MORE_FORM {
	...
	public function shortcode_init() {
		...
		if ( $wot_tracking_more_form !== null ) {
			...
			wp_enqueue_script( 'vi-wot-tracking-more-form', VI_WOO_ORDERS_TRACKING_JS . 'tracking-more-form' . $src_min . '.js', array( 'jquery' ), VI_WOO_ORDERS_TRACKING_VERSION , false);
			wp_enqueue_style( 'vi-wot-tracking-more-form', VI_WOO_ORDERS_TRACKING_CSS . 'tracking-more-form' . $src_min . '.css', '', VI_WOO_ORDERS_TRACKING_VERSION );
