...
[Try the Demo](http://new2new.com/?item=woo-orders-tracking "Demo Orders Tracking for WooCommerce") | [Documents](http://docs.villatheme.com/woo-orders-tracking "Documents") | [Pro Version](https://villatheme.com/extensions/woocommerce-orders-tracking/ "Premium Version") | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")
...
[GET PRO VERSION](https://villatheme.com/extensions/woocommerce-orders-tracking/)
...
2. Upload `woo-orders-tracking` to the `/wp-content/plugins/` directory
...
2022.05.13 - version 1.1.16
- Fixed: PHP error below settings page in some cases

2022.04.22 - version 1.1.15
- Fixed: Sanitize, escape data
- Fixed: Save filter settings
- Updated: VillaTheme_Support

2022.03.29 - version 1.1.14
- Updated: VillaTheme_Support

2022.03.21 - version 1.1.13
- Updated: VillaTheme_Support

2022.01.15 - version 1.1.12
- Fixed: Deprecated is_ajax in WC6.1

2022.01.12 - version 1.1.11
- Updated: VillaTheme_Support

2021.12.14 - version 1.1.10
- Fixed: Patched XSS vulnerability

2021.11.17 - version 1.1.9
- Fixed: Tracking URL of Fedex and Portugal Post - CTT

2021.09.09 - version 1.1.8.7
